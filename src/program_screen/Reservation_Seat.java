...
public class Reservation_Seat extends JFrame {
	...
	private int selectseat = Reservation_Personnel.personnel;
	/*private int selectseat =4;*/
	private int count = 0;
	private String row;
	private int column, rowNum;
	...
	public void selectSeat(JButton button) {
		String seat = button.getText(); // 좌석 이름
		row = seat.substring(0, 1); // 행
		column = Integer.parseInt(seat.substring(1)); // 열
	...
	public Reservation_Seat() {
		...
		btnA1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(count >= selectseat)
					JOptionPane.showMessageDialog(null, "주의) 인원 초과. 선택하신 인원은 " + seat + " 명 입니다.");
				else {
					count++;
					btnA1.setBackground(Color.PINK);
					selectSeat(btnA1);
				}
			}
		});
		...
		btnA2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(count >= selectseat)
					...
					count++;
					btnA2.setBackground(Color.PINK);
					selectSeat(btnA2);
				}
			}
		});
		...
		btnB1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(count >= selectseat)
					...
					count++;
					btnB1.setBackground(Color.PINK);
					selectSeat(btnB1);
				}
			}
		});
		...
		btnB2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(count >= selectseat)
					...
					count++;
					btnB2.setBackground(Color.PINK);
					selectSeat(btnB2);
				}
			}
		});
		...
		btnC1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(count >= selectseat)
					...
					count++;
					btnC1.setBackground(Color.PINK);
					selectSeat(btnC1);
				}
			}
		});
		...
		btnC2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(count >= selectseat)
					...
					count++;
					btnC2.setBackground(Color.PINK);
					selectSeat(btnC2);
				}
			}
		});
		...
		btnD1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(count >= selectseat)
					...
					count++;
					btnD1.setBackground(Color.PINK);
					selectSeat(btnD1);
				}
			}
		});
		...
		btnD2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(count >= selectseat)
					...
					count++;
					btnD2.setBackground(Color.PINK);
					selectSeat(btnD2);
				}
			}
		});
		...
		btnE1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(count >= selectseat)
					...
					count++;
					btnE1.setBackground(Color.PINK);
					selectSeat(btnE1);
				}
			}
		});
		...
		btnE2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(count >= selectseat)
					...
					count++;
					btnE2.setBackground(Color.PINK);
					selectSeat(btnE2);
				}
			}
		});
		...
		btnF1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(count >= selectseat)
					...
					count++;
					btnF1.setBackground(Color.PINK);
					selectSeat(btnA1);
				}
			}
		});
		...
		btnF2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(count >= selectseat)
					...
					count++;
					btnF2.setBackground(Color.PINK);
					selectSeat(btnA1);
				}
			}
		});
		...
		lblPrice.setFont(new Font("굴림", Font.PLAIN, 18));
		...
		txtPrice.setText(Reservation_Personnel.price);
		...
		lblScreen.setFont(new Font("굴림", Font.PLAIN, 20));
